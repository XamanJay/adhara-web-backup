! function(t, e) {
    ...
    return function(t) {
                ...
                if (this.shouldAllowMouseEnter(e)) {
                    ...
                    if ([...this.picker.querySelectorAll(`.${s.dayItem}`)].forEach(t => {
                        ...
                        if (this.options.hotelMode || (n += 1), n > 0) {
                            const i = t.select(n),
                                o = `${n} ${this.options.tooltipText[i]?this.options.tooltipText[i]:` [$ {
                                    i
                                }]
                            `}`;
            ...
            renderDay(t) {
                ...
                if (this.datePicked.length <= 1 && this.options.bookedDays.length) {
                    ...
                    const s = this.dateIsBooked(t, i),
                        ...
                        r = 0 === this.datePicked.length && s || 1 === this.datePicked.length && a && s,
                        l = this.options.anyBookedDaysAsCheckout && 1 === this.datePicked.length;
                    r && !l && e.classList.add(n.isBooked)
                }
        ...
        function k(t, e) {
            ...
            if (e.singleton) {
                var s = g++;
                i = u || (u = c(e)), o = p.bind(null, i, s, !1), n = p.bind(null, i, s, !0)
            } else i = c(e), o = m.bind(null, i, e), n = function() {
                ! function(t) {
