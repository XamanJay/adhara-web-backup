		...
		<div class="container">
			...
			<div  id="wrapper-content" style="padding-top: 60px;">
				...
				<div class="wrapper_img">
					<img src="/img/services/pool/pool_2021.png" alt="Cuartos" class="img-fluid desktop">
					<img src="/img/services/pool/pool_mobile_2021.png" alt="Cuartos" class="img-fluid mobile">
				</div>
