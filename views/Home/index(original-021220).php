			...
			<div  id="wrapper-content">
				...
				<div id="hold-whats">
					...
					<div id="todays-rate">
						...
						<p style="margin-top: 20px;margin-bottom: 0px;">¡Tarifa de reapertura!</p>
						<!--img src="img/icons/timer.png" alt=""-->
						<div class="clearfix"></div>
						<h4 id="price-up">$ 1,250 MXN</h4>
						<p style="margin-bottom: 0px;margin-top: 10px;font-weight: bolder;color: white;"><?php echo $_GLOBALS['rates-taxes']; ?></p>
					</div>

					<div id="hold-tarifa">
						Cotiza reserva y paga por
					</div>
					<div id="label-info">
						<h2 style="text-align: center;font-weight: 800;">Whatsapp</h2>
		
						<p id="phone-label">998 122 18 61</p>
						<img src="img/icons/whats.png" alt="">
					</div>
					<!--img src="<?php echo $_GLOBALS['reapertura']; ?>" alt="Reapertura" style="width:250px;"-->
					
				</div>

				<!-- Main img -->
				<div id="main-img">
					<img src="<?php echo $_GLOBALS['url-home-500']; ?>" alt="Hotel Adhara Cancún" class="img-home" id="img-small">
