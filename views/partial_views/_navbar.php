  ...
  <div id="head_">
    ...
    <div class="navbar" id="mob_menu">
      <ul class="navbar-nav ml-auto" id="menu_desktop">
        ...
        <li class="nav-item">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="services_drop" id="services_menu">
              ...
              <a class="dropdown-item" href="/coco"><?php echo $_GLOBALS['header_cocodrillo']; ?></a>
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center butt btn-5 btn-5bb icon-estrella" href="/estrella"><span>CLUB ESTRELLA</span></a>
        </li>
        <li class="nav-item">
...
<div id="covid-19">  
  <p><a href="/update-covid-19" style="font-size: x-small; text-align: right;">ACTUALIZACIÓN COVID-19</a> </p>
</div>
