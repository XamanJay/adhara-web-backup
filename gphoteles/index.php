...
require 'controllers/Rooms/RoomsController.php';
require 'controllers/Rooms/HotelsController.php';
require 'controllers/Season/SeasonsController.php';
require 'controllers/Edit/EditController.php';
require 'email/class.phpmailer.php';
require 'controllers/Multimedia/multimediaController.php';
