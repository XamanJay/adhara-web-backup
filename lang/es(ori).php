...
/* Imagen Home */
$_GLOBALS['reapertura'] = "/img/reapertura_neww.png";
$_GLOBALS['url-home-800'] = "/img/img_main_es_medium.png";
$_GLOBALS['url-home-500'] = "/img/img_main_es_small.png";
$_GLOBALS['home-image'] = "img/img_main_es_big.png";

/* description money */
$_GLOBALS['description_money'] = "M/N";
...
$_GLOBALS['grupos_whatsapp'] = "img/grupos/whatsapp_grupos_esp.png";
...
$_GLOBALS['shuttle-img'] = "/img/services/shuttle/Transportation_esp_desktop_001.png";
$_GLOBALS['shuttle-img-mob'] = "/img/services/shuttle/Transportation_esp_mobile_001.png";

$_GLOBALS['club-img'] = "img/places/clubestrella2021.png";   
...
$_GLOBALS['clubestrella-img'] = "img/clubestrella/cs_rewards_2021.png";
$_GLOBALS['clubestrella-img2'] = "img/clubestrella/subscribe.png";
$_GLOBALS['clubestrella-img3'] = "img/clubestrella/logos_cs_2021.png";
$_GLOBALS['clubestrella-img4'] = "img/clubestrella/btn_subscribe.png";
$_GLOBALS['clubestrella-img-mbo'] = "img/clubestrella/mob_cs_rewards_2021.png";
$_GLOBALS['clubestrella-img3-mbo'] = "img/clubestrella/mob_logos_cs_2021.png";
...
$_GLOBALS['clubestrella-h1_2021'] = "Canjea tus puntos por productos y servicios "; 

$_GLOBALS['clubestrella-h2_2021'] = " El programa de recompensas para el viajero frecuente,"; 
$_GLOBALS['clubestrella-h3_2021'] = " creado para reconocer su preferencia mediante"; 
$_GLOBALS['clubestrella-h4_2021'] = " beneficios exclusivos.";   

$_GLOBALS['clubestrella-h5_2021'] = " COMIENZA A SUMAR PUNTOS ";   
$_GLOBALS['clubestrella-h6_2021'] = " CON NUESTROS SOCIOS: ";   

$_GLOBALS['clubestrella-hh7']  = "¡También cambia tus puntos por diferentes premios!";
$_GLOBALS['clubestrella-hh8']  = "Cerveza.";
$_GLOBALS['clubestrella-hh9']  = "Ascenso a habitación de categoria superior.";
$_GLOBALS['clubestrella-hh10'] = "Desayuno Buffet o Menú Ejecutivo.";
$_GLOBALS['clubestrella-hh11'] = "Cocodrillo Grilled Sándwich.";
$_GLOBALS['clubestrella-hh12'] = "Noche Gratis Hotel Adhara Hacienda Cancún.";
$_GLOBALS['clubestrella-hh13'] = "Cafetería Dolce Gusto.";
$_GLOBALS['clubestrella-hh14'] = "Ipod Touch 64 GB.";
$_GLOBALS['clubestrella-hh15'] = "Imágenes ilustrativas, los modelos pueden variar.";
...
$_GLOBALS['covid-home'] = 'img/covid/New_pool_2021_info_covid_desktop.png';
$_GLOBALS['covid-home-mob'] = 'img/covid/New_pool_2021_info_covid_mobile.png';

$_GLOBALS['covid-home-text'] = 'Hotel Adhara Cancún y Grupo Peninsular de Hoteles contamos con protocolos para nuestros colaboradores y huéspedes, tomando en cuenta las disposiciones oficiales a nivel municipal, estatal y federal, así como la información compartida por la Organización Mundial de la Salud.';


$_GLOBALS['covid-welcome-p1'] = 'Medidas de entrada y salida para huéspedes así como implementación de tapetes sanitizantes.';
$_GLOBALS['covid-welcome-p2'] = 'Nuestros anfitriones (Recepción) se encuentran capacitados con los protocolos de Prevención de Seguridad e Higiene.';
$_GLOBALS['covid-welcome-p3'] = 'Toma de temperatura a todos los huéspedes al llegar al Resort y antes del Check in.';
$_GLOBALS['covid-welcome-p4'] = 'Estaciones de gel antibacterial.';
$_GLOBALS['covid-welcome-p5'] = 'Desinfectar todo el equipaje a la llegada en área especial.';
$_GLOBALS['covid-welcome-p6'] = 'Protocolos especiales para casos sospechosos.';



$_GLOBALS['covid-areas-p1'] = 'Protocolos de limpieza en áreas comunes de huéspedes y colaboradores, usando una variedad de productos que cumplen  con las especificaciones  en soluciones de limpieza y desinfección.';
$_GLOBALS['covid-areas-p2'] = 'Dispensadores automáticos de gel antibacterial localizados en puntos clave y visibles para nuestros huéspedes y visitantes.';
$_GLOBALS['covid-areas-p3'] = 'En los elevadores solo se permitirán 2 personas a la vez excepto familias viajando juntas.';
$_GLOBALS['covid-areas-p4'] = 'Los huéspedes son invitados a practicar distancia social (1.5 metros).';
$_GLOBALS['covid-areas-p5'] = 'Limpieza y desinfección de todo el  mobiliario y equipo  cumpliendo los protocolos establecidos.';



$_GLOBALS['covid-habitaciones-p1'] = 'Nuestras  habitaciones son limpiadas y desinfectadas profundamente usando productos que cumplen con las normas de sanitización después de cada salida de huésped.';
$_GLOBALS['covid-habitaciones-p2'] = 'Toda la ropa de cama y toallas serán cambiadas diariamente y lavadas en altas temperaturas y con los productos biodegradables y de sanitización.';
$_GLOBALS['covid-habitaciones-p3'] = 'Se desinfectan todos los artículos tocados frecuentemente tales como chapas, apagadores, teléfonos, control remoto y áreas de contacto directo.';
$_GLOBALS['covid-habitaciones-p4'] = 'Por control de Salud hemos retirado de la habitación, cafeteras y amenidades que puede solicitar a nuestra Recepción y Ama de llaves y con gusto se lo haremos llegar.';
$_GLOBALS['covid-habitaciones-p5'] = 'Contamos con gel antibacterial en todas las habitaciones como parte de las amenidades durante su estancia.';



$_GLOBALS['covid-restaurante-p1'] = 'Nuestro restaurante y bar cumplen con los  estándares de higiene en manejo de alimentos y bebidas.';
$_GLOBALS['covid-restaurante-p2'] = 'Nuestra cocina y utensilios son lavados y desinfectados con altas temperaturas y  productos de limpieza que cumplen con las normas establecidas.';
$_GLOBALS['covid-restaurante-p3'] = 'Los colaboradores son instruidos para usar guantes y cubre bocas en todo momento.';
$_GLOBALS['covid-restaurante-p4'] = 'Las  mesas de  nuestro restaurante fueron colocados  de acuerdo a las recomendaciones de distancia social que marca el Gobierno municipal, estatal y Federal, así como instituciones de salud como la OMS.';
$_GLOBALS['covid-restaurante-p5'] = 'Los colaboradores utilizan cubre bocas con careta para la seguridad e higiene.';
$_GLOBALS['covid-restaurante-p6'] = 'Hemos diseñado un esquema de manejo mínimo de utensilios, platos, vasos y tazas cuidando su salud.';



$_GLOBALS['covid-transporte-p1'] = 'Nuestras camionetas  son lavadas y desinfectados profundamente antes y después de cada servicio.';
$_GLOBALS['covid-transporte-p2'] = 'Todo el equipaje es desinfectado antes de subirlo al vehículo.';
$_GLOBALS['covid-transporte-p3'] = 'El Chofer mantendrá sana distancia, usando siempre  cubre bocas y careta además  de gel desinfectante de manos.';


$_GLOBALS['covid-colaborador-p1'] = 'Todos los colaboradores han recibido capacitación en los protocolos de limpieza y seguridad de COVID 19.';
$_GLOBALS['covid-colaborador-p2'] = 'Los colaboradores que tienen contacto más frecuente con huéspedes reciben una capacitación más dedicada y profunda, incluyendo colaboradores de Restaurantes, Bares, Ama de Llaves, Áreas Públicas, Seguridad y Anfitriones.';
$_GLOBALS['covid-colaborador-p3'] = 'No se dará acceso a la propiedad a ningún colaborador que presente síntomas de enfermedad.';
$_GLOBALS['covid-colaborador-p4'] = 'La empresa cuenta con protocolos especialmente diseñados para colaboradores, proveedores y visitantes.';
$_GLOBALS['covid-colaborador-p5'] = 'El Hotel cuenta con un Protocolo de casos sospechoso de COVID 19.';


$_GLOBALS['covid-gym-p1'] = 'El equipo del gimnasio será limpiado con toallas desinfectantes inmediatamente después de cada uso.';
$_GLOBALS['covid-gym-p2'] = 'Se ofrecerá únicamente agua embotellada.';

$_GLOBALS['menu_adhara'] = "/img/menus/menu_adharaa_es.png";
$_GLOBALS['room_service_adhara'] = "/img/menus/adhara_room_servicee_es.png";
