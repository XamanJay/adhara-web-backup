  ...
  try {
    ...
    if($count > 0){
      ...
      if ($authorizeID !=""  && $error != "Error " && $authorizeID !="000000" && $message!="Rechazado"){ //actualizo reserva aceptada
        ...
        if($count2 > 0){
          ...
          if($count3 > 0){
              ...
              if($count4 > 0){
                  ...
                  if($allotment == 0)
                    $emailController->allotmentOut($room['cuarto']->getNombre(),$orderInfo);
                  ...
                  if(!$mail->Send()){
                    ...
                    header( "Location: /deposito/errormail?r=".$orderInfo."");

                  }else{
                    $estatus = "aceptado";
                    header( "Location: https://adharacancun.com/banamex/amex?order=".$orderInfo."&msg=".$message."&txn=".$txnResponseCode."&estatus=".$estatus."&id=".$authorizeID."" );
                  }
              }    
          }
        }
        ...
        $estatus = "rechazado";
        header( "Location: https://adharacancun.com/banamex/amex?msg=".$message."&estatus=".$estatus."" );
      }
